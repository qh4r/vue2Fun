...
<style lang="scss">
    .container {
        ...
        display: flex;
        align-items: center;
        /*align items ustawia alignment w linii a align content ustawia alignment w wielu liniach*/
